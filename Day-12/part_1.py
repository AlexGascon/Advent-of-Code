...
def test_programs_contained():
    ...
    6 <-> 4, 5
    """
    assert programs_contained(example) == 6
...
def test_parse_programs():
    ...
    assert parse_programs(example) == expected_result
...
def programs_contained(programs_diagram):
...
if __name__ == '__main__':
    ...
    result = programs_contained(input_content)
    print(f"PROGRAMS CONNECTED TO 0: {result}")
