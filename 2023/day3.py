...
class Day3:
    ...
    def part2(self, schematic=None):
        # input_file = "inputs/test/day3.txt"
        input_file = "inputs/day3.txt"
        ...
        gear_ratios = []
        for symbol_position in symbol_pos:
            part = schematic[symbol_position]

            if part == self.GEAR_SYMBOL:
                nums = self.get_adjacent_numbers(schematic, symbol_position)
